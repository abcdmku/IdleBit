...
- Cache meter states are visually distinct as fixed-height Buffer, Load, and Ready lanes; CPU-filled cache buffers fill a dashed track at CPU speed with a solid cache-write overlay at cache speed; completed tasks release cache immediately and do not leave held/resident bits.

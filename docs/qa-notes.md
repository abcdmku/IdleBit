...
- Progression gates:
  - Cache capacity upgrades are data-weighted; cache speed upgrades are available immediately and cost credits only.
  ...
  - RAM buys new base sticks, then upgrades selected-stick or all-stick capacity and frequency independently; mixed capacity and frequency are allowed, capacity is data-weighted, and frequency costs credits only.

...
- Staging and reliability:
  ...
  - Default RAM writes allocate on stick 1. Dual, Quad, and Oct Channel RAM research let the System Scheduler stripe writes across 2/4/8 installed sticks, and the RAM panel reports active/max channels plus effective write bandwidth.

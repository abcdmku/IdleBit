...
export const componentSkus: CatalogComponentSkuDefinition[] = [
  ...
  },
  {
    ...
    unlockResearchId: "systemCatalog",
    offTheShelf: true,
    description: "Balanced CPU package for elastic build work.",
  ...
  },
  {
    ...
    unlockResearchId: "systemCatalog",
    offTheShelf: true,
    description: "Four 2 Kb sticks for elastic compile work.",
  ...
  },
  {
    ...
    unlockResearchId: "systemCatalog",
    offTheShelf: true,
    description: "Enough system queue width for elastic local work.",
